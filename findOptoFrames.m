function [mode_firstShuttered,mode_secondShuttered,baselineFrames,postOptoFrames,preShutterFrames,postShutterFrames]=findOptoFrames(trials,thresh,nFramesAfterOpto,nFramesForBase)

% trials: cell array of cell arrays (frames) -- each frame in each trial
%       contains tif stack of images collected in that trial
% Suggestion: thresh=8; 
% thresh: Threshold above which frame is considered to be opto
